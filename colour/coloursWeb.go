...
//nolint:mnd
var (
	webColours = withAliases(colourNameToRGBA{
	...
	cgaColours = withAliases(colourNameToRGBA{
		"white":        {R: 0xFF, G: 0xFF, B: 0xFF, A: 0xFF},
	...
	cgaColoursByNum = map[int]rgba{
		15: {R: 0xFF, G: 0xFF, B: 0xFF, A: 0xFF}, // white
		7:  {R: 0xC0, G: 0xC0, B: 0xC0, A: 0xFF}, // light grey / light gray
		8:  {R: 0x80, G: 0x80, B: 0x80, A: 0xFF}, // dark grey / dark gray
		0:  {R: 0x00, G: 0x00, B: 0x00, A: 0xFF}, // black
		12: {R: 0xFF, G: 0x00, B: 0x00, A: 0xFF}, // high red
		4:  {R: 0x80, G: 0x00, B: 0x00, A: 0xFF}, // low red
		14: {R: 0xFF, G: 0xFF, B: 0x00, A: 0xFF}, // yellow
		6:  {R: 0x80, G: 0x80, B: 0x00, A: 0xFF}, // brown
		10: {R: 0x00, G: 0xFF, B: 0x00, A: 0xFF}, // high green / green
		2:  {R: 0x00, G: 0x80, B: 0x00, A: 0xFF}, // low green
		11: {R: 0x00, G: 0xFF, B: 0xFF, A: 0xFF}, // high cyan / cyan
		3:  {R: 0x00, G: 0x80, B: 0x80, A: 0xFF}, // low cyan
		9:  {R: 0x00, G: 0x00, B: 0xFF, A: 0xFF}, // high blue
		1:  {R: 0x00, G: 0x00, B: 0x80, A: 0xFF}, // low blue
		13: {R: 0xFF, G: 0x00, B: 0xFF, A: 0xFF}, // high magenta / magenta
		5:  {R: 0x80, G: 0x00, B: 0x80, A: 0xFF}, // low magenta
	}
)
